    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: [
                ...
                'message2' => "Your transfer-in instruction (reference code: {$this->data['metadata']['reference_number']}) for {$this->data['metadata']['amount']} {$this->data['metadata']['currency']} has been cancelled.",
