    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="mb-10">
            ...
            <div>
                ...
                <span class="text-sm font-semibold peer-checked:text-gray-400 text-purple-600 transition-colors duration-300" id="bank-label">
                    Bank Accounts
                </span>
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <div class="w-16 h-8 bg-gray-200 peer-focus:ring-4 peer-focus:ring-purple-300 rounded-full shadow-inner transition-all duration-300 peer-checked:bg-purple-600">
                            <div id="circle" class=" absolute top-1 left-1 bg-white w-6 h-6 rounded-full shadow-lg transform peer-has-checked:bg-purple-600 transition-all duration-300 flex items-center justify-center">
                                <svg class="w-3.5 h-3.5 text-purple-600 opacity-0 peer-checked:opacity-100 transition-all duration-300" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                                </svg>
                            </div>
                        </div>
                    </label>
                    <span class="text-sm font-semibold text-gray-400 peer-checked:text-purple-600 transition-colors duration-300" id="crypto-label">
                    Crypto Wallets
                </span>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">SWIFT/Sort Code</th>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Entity Details</th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <div class="text-sm font-semibold text-gray-900">{{ $account->bank_name }}</div>
                                                    <div class="text-sm text-gray-500">SWIFT: {{ $account->swift }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @if(isset($account->thirdPartyAccount->company))
                                                ...
                                                <div class="text-sm text-gray-500">Reg: {{ $account->thirdPartyAccount->company->address->address_line1 }}</div>
                                            @else
                                                <div class="text-sm text-gray-900">{{ $account->thirdPartyAccount->individual->fullName() }}</div>
                                                <div class="text-sm text-gray-500">Reg: {{ $account->thirdPartyAccount->individual->address->address_line1 }}</div>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $account->is_verified ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-12 text-center">
                                            ...
                                            <h3 class="mt-2 text-sm font-medium text-gray-900">No third party accounts</h3>
                                            <p class="mt-1 text-sm text-gray-500">Add third party accounts for your business partners.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Wallet Name</th>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            @if($wallet->currency && $wallet->currency->icon)
                                                <img src="{{ asset('storage/' . $wallet->currency->icon) }}" alt="{{ $wallet->currency->name }}" class="h-10 w-10 rounded-full">
                                            @else
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">Start by adding your first crypto wallet.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
