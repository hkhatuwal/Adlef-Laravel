        ...
        <div class="container mx-auto px-4 py-16">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    ...
                    <div class="group">
                        <div
                            class="transfer-option h-full bg-white border-2 border-gray-100 rounded-2xl p-8 text-center transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl hover:border-black cursor-pointer"
                            data-type="transfer-in" data-url="{{route('client.transfer.in')}}">
                            <div class="mb-6 relative">
                                <div
                                    class="w-16 h-16 mx-auto bg-blue-50 rounded-2xl flex items-center justify-center group-hover:bg-blue-100 transition-colors duration-300">
                                    <img src="{{ asset('assets/images/transfer-in.svg') }}" alt="Transfer In"
                                         class="w-8 h-8">
                                </div>
                            </div>
                    ...
                    <div class="group">
                        <div
                            ...
                            <div class="mb-6 relative">
                                <div
                                    class="w-16 h-16 mx-auto bg-red-50 rounded-2xl flex items-center justify-center group-hover:bg-red-100 transition-colors duration-300">
                                    <img src="{{ asset('assets/images/transfer-out.svg') }}" alt="Transfer Out"
                                         class="w-8 h-8">
                                </div>
                            </div>
                    ...
                    <div class="group">
                        <div
                            ...
                            <div class="mb-6 relative">
                                <div
                                    class="w-16 h-16 mx-auto bg-purple-50 rounded-2xl flex items-center justify-center group-hover:bg-purple-100 transition-colors duration-300">
                                    <img src="{{ asset('assets/images/third-party.svg') }}" alt="Third Party Transfer"
                                         class="w-8 h-8">
                                </div>
                            </div>
