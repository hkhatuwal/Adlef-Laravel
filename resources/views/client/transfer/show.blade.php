...
<div class="min-h-screen bg-gradient-to-br from-slate-100 to-white py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex items-center mb-6">
            <a href="{{ route('client.transfer') }}" class="group inline-flex items-center text-slate-700 hover:text-blue-700 transition-colors">
                ...
                <div class="px-6 py-5 bg-gradient-to-r from-blue-700 to-indigo-800">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-blue-200">Transaction ID: {{ $transfer->reference_number }}</p>
                        </div>
                ...
                <div class="px-6 py-8 text-center bg-white">
                    ...
                    <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-100">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-blue-900">{{ number_format($transfer->fee, 8) }} {{ $transfer->currency->symbol }}</span>
                        </div>
                    </div>
                    @endif
                </div>
                ...
                <div class="divide-y divide-slate-200">
                            ...
                            <span class="text-sm font-medium text-slate-900">
                                ...
                                @if($fromAccountType === 'BankAccount')
                                    ...
                                    @if($fromAccount->account_type)
                                        <br><span class="text-sm text-slate-500">Type: {{ $fromAccount->account_type }}</span>
                                    @endif
                                @elseif($fromAccountType === 'CryptoWallet')
                                    {{ $fromAccount->currency->name }} Wallet
                            ...
                            <span class="text-sm font-medium text-slate-900">
                                ...
                                @if($toAccountType === 'BankAccount')
                                    ...
                                    @if($toAccount->account_type)
                                        <br><span class="text-sm text-slate-500">Type: {{ $toAccount->account_type }}</span>
                                    @endif
                                @elseif($toAccountType === 'CryptoWallet')
                                    {{ $toAccount->currency->name }} Wallet
                    ...
                    <div class="px-6 py-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-slate-900">{{ $transfer->reference_number }}</span>
                        </div>
                    </div>
                </div>
            </div>
