            ...
            <div class="mb-8">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-600">Track all your transactions and activities in one
                            place</p>
                    </div>
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="relative">
                            ...
                            <div id="filterDropdown"
                                 class="hidden opacity-0 transform scale-95 origin-top-right absolute right-0 mt-3 w-80 rounded-xl shadow-xl bg-white ring-1 ring-black ring-opacity-5 transition-all duration-200 z-50">
                                <div class="p-5 space-y-6">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input type="date" name="start_date"
                                                       class="block w-full rounded-lg border-slate-200 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 text-sm transition-all duration-200"
                                    ...
                                    <div>
                                        ...
                                        <select name="type"
                                            ...
                                            <option value="{{ \App\Models\UserActivity::TYPE_ASSET_TRANSFER }}">Asset
                                                Transfers
                                            </option>
                                            <option value="{{ \App\Models\UserActivity::TYPE_OTC_TRADE }}">OTC Trades
                                            </option>
                                            <option value="{{ \App\Models\UserActivity::TYPE_CRYPTO_WITHDRAWAL }}">
                                                Crypto Withdrawals
                                            </option>
                                            <option value="{{ \App\Models\UserActivity::TYPE_FIAT_WITHDRAWAL }}">Fiat
                                                Withdrawals
                                            </option>
                                            <option value="{{ \App\Models\UserActivity::TYPE_DEPOSIT }}">Deposits
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="filter-status">
                                        ...
                                        <div class="grid grid-cols-2 gap-3">
                                            <label
                                                class="relative flex items-center p-3 rounded-lg border border-slate-200 hover:border-blue-500 cursor-pointer transition-all duration-200">
                                                ...
                                                <div
                                                    class="absolute inset-0 rounded-lg peer-checked:border-2 peer-checked:border-blue-500 pointer-events-none"></div>
                                            </label>
                                            <label
                                                class="relative flex items-center p-3 rounded-lg border border-slate-200 hover:border-emerald-500 cursor-pointer transition-all duration-200">
                                                <input type="radio" name="status"
                                                       value="{{ \App\Models\UserActivity::STATUS_COMPLETED }}"
                                                       class="peer sr-only">
                                                <div class="flex items-center">
                                                ...
                                                <div
                                                    class="absolute inset-0 rounded-lg peer-checked:border-2 peer-checked:border-emerald-500 pointer-events-none"></div>
                                            </label>
                                            <label
                                                class="relative flex items-center p-3 rounded-lg border border-slate-200 hover:border-amber-500 cursor-pointer transition-all duration-200">
                                                <input type="radio" name="status"
                                                       value="{{ \App\Models\UserActivity::STATUS_PENDING }}"
                                                       class="peer sr-only">
                                                <div class="flex items-center">
                                                ...
                                                <div
                                                    class="absolute inset-0 rounded-lg peer-checked:border-2 peer-checked:border-amber-500 pointer-events-none"></div>
                                            </label>
                                            <label
                                                class="relative flex items-center p-3 rounded-lg border border-slate-200 hover:border-red-500 cursor-pointer transition-all duration-200">
                                                <input type="radio" name="status"
                                                       value="{{ \App\Models\UserActivity::STATUS_FAILED }}"
                                                       class="peer sr-only">
                                                <div class="flex items-center">
                                                ...
                                                <div
                                                    class="absolute inset-0 rounded-lg peer-checked:border-2 peer-checked:border-red-500 pointer-events-none"></div>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-3 pt-2">
                                        <button type="button" id="resetFiltersBtn"
                                                class="flex-1 inline-flex justify-center items-center px-4 py-2.5 border border-slate-300 text-sm font-medium rounded-lg text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-all duration-200">
                                            <i class="fa-solid fa-rotate-left mr-2"></i>
                                            Reset
                                        </button>
                                        <button type="button" id="applyFiltersBtn"
                                                class="flex-1 inline-flex justify-center items-center px-4 py-2.5 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
