...
<div class="min-h-screen bg-gradient-to-br from-slate-100 to-white py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex items-center mb-6">
            <a href="{{ route('client.otc.index') }}" class="group inline-flex items-center text-slate-700 hover:text-blue-700 transition-colors">
                ...
                <div class="px-6 py-5 bg-gradient-to-r from-blue-700 to-indigo-800">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-blue-200">Transaction ID: {{ $otcRequest->reference_number }}</p>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-start">
                            ...
                            <div class="flex items-center">
                                ...
                                <button class="ml-2 text-blue-700 hover:text-blue-800 transition-colors" onclick="copyToClipboard('{{ $otcRequest->toCurrency->getMyAssetAccount()?->wallet_address }}')">
