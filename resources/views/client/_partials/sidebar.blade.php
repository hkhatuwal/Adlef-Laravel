            ...
            <ul class="space-y-2 mt-10">
                <li>
                    <a href="{{ route('client.dashboard') }}"
                       class="flex items-center px-4 py-2 text-gray-700  font-semibold hover:bg-gray-100 rounded-lg {{ request()->routeIs('dashboard') ? 'bg-gray-100' : '' }}">
                ...
                <li>
                    <a href="{{ route('client.holdings') }}"
                       class="flex items-center px-4 py-2 text-gray-700 font-semibold hover:bg-gray-100 rounded-lg {{ request()->routeIs('holdings') ? 'bg-gray-100' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
