    ...
    <div style="background-color: #f8f9fa; border-radius: 6px; padding: 20px; margin-bottom: 25px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="padding: 8px 0;">{{ \Carbon\Carbon::parse($processed_at)->format('d-m-Y H:i') }} GMT+8</td>
            </tr>
            <tr>
                <td style="padding: 8px 0; width: 40%; color: #6c757d; font-weight: bold;">Processed By:</td>
                <td style="padding: 8px 0;">{{ $processed_by }}</td>
            </tr>
        </table>
    </div>
