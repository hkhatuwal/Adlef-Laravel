...
@section('content')
    ...
    <section class="container mx-auto px-4 md:p-10 mt-10">
        <div class="flex flex-row justify-start items-start gap-4">
            <div class="flex flex-col gap-2 sticky left-0 top-2">
                <div class="py-8 px-6 bg-black text-white min-w-[17rem]">
                ...
                <div class="py-8 px-6  min-w-[17rem] flex flex-col gap-4 items-center justify-center border ">
            ...
            <div class="bg-white ">
                ...
                <form class="space-y-8 divide-y divide-gray-200 px-4 py-5 sm:p-6" method="POST"
