@extends('_partials.app',['isDark'=>true,'title' => 'ADLEF GROUP | SOLUTIONS','description' => 'We integrate our service offerings to provide clients full-turnkey solutions.'])
@section('content')
