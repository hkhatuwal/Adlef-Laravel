@extends('_partials.app',['title' => config('app.name').' | Contact Us','description' => 'Power your finances with our personalized platform designed for Multi-asset servicing, seamlessly connecting traditional and digital financial ecosystems','image' => asset('assets/images/savings.svg'),'isDark' => true])
@section('content')
        ...
        <div class="bg-gray-800 p-6 mt-8">
            <div class="container mx-auto  ">
                ...
                <div class="text-center md:text-left">
                    ...
                    <p class="text-gray-600">For general inquiries, please email us at <a href="mailto:support@adlefgroup.com" class="text-blue-500 hover:underline">support@adlefgroup.com</a>
                        <span>or Whats app <a href="https://wa.me/447415774119" class="text-blue-500 hover:underline">+447415774119</a></span>.</p>
                </div>
