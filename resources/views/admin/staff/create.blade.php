...
@section('content')
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-semibold text-slate-800 dark:text-white">Create Staff Member</h1>
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Add a new staff member with role-based permissions</p>
            </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow">
            <div class="p-6">
                <form method="POST" action="{{ route('admin.staff.store') }}" class="space-y-8">
                    @csrf
