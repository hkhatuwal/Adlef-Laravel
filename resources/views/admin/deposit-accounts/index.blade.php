    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h3 class="text-xl font-semibold text-gray-800">Deposit Accounts</h3>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-500">
                                        @foreach($account->fields as $field)
                                            <div class="mb-1">
                                                <span class="font-medium">{{ $field->field_name }}:</span>
                                                {{ $field->field_value }}
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <a href="{{ route('admin.deposit-accounts.edit', $account) }}" 
                                           class="text-blue-600 hover:text-blue-900">
                                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                        </a>
                                        <form action="{{ route('admin.deposit-accounts.destroy', $account) }}" 
                                              method="POST" 
                                              class="inline-block"
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                                    ...
                                    <a href="{{ route('admin.deposit-accounts.create') }}" class="text-blue-600 hover:text-blue-900 ml-1">Create one now</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
