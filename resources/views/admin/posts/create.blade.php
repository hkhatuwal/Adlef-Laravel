...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-600">Add a new post to your blog</p>
            </div>
    ...
    <!-- Form Section -->
    <div class="max-w-3xl">
        <form action="{{route('admin.posts.store')}}" method="POST" class="space-y-8" enctype="multipart/form-data">
            @csrf
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="links hidden space-y-6">
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div>
